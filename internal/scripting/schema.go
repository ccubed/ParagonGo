		...
		Functions: []ScriptFuncDef{
			...
			},
			{
				...
				Params: []ScriptFuncParam{
					...
					{Name: "mob", Type: "ActorObject", Description: "The mob."},
					{Name: "room", Type: "RoomObject", Description: "The room the mob is in."},
					{Name: "eventDetails", Type: "CommandEventDetails", Description: "Contains sourceId (int) and sourceType ('user' or 'mob')."},
				},
				ReturnType:      "boolean | void",
				ReturnSemantics: "Return true to halt further command processing.",
			...
			},
			{
				...
				Params: []ScriptFuncParam{
					...
					{Name: "room", Type: "RoomObject", Description: "The room the mob is in."},
					{Name: "eventDetails", Type: "GiveEventDetails", Description: "Contains sourceId, sourceType, item (ItemObject), and gold (int)."},
				},
				ReturnType:      "boolean | void",
			...
			},
			{
				...
				Params: []ScriptFuncParam{
					...
					{Name: "room", Type: "RoomObject", Description: "The room the mob is in."},
					{Name: "eventDetails", Type: "ShowEventDetails", Description: "Contains sourceId, sourceType, and item (ItemObject)."},
				},
				ReturnType:      "void",
				ReturnSemantics: "Return value is ignored.",
			...
			},
			{
				...
				Params: []ScriptFuncParam{
					...
					{Name: "room", Type: "RoomObject", Description: "The room the mob is in."},
					{Name: "eventDetails", Type: "AskEventDetails", Description: "Contains sourceId, sourceType, and askText (string)."},
				},
				ReturnType:      "boolean | void",
			...
			},
			{
				...
				Params: []ScriptFuncParam{
					...
					{Name: "room", Type: "RoomObject", Description: "The room the mob is in."},
					{Name: "eventDetails", Type: "HurtEventDetails", Description: "Contains sourceId, sourceType, damage (int), and crit (bool)."},
				},
				ReturnType:      "void",
				ReturnSemantics: "Return value is ignored.",
			...
			},
			{
				...
				Params: []ScriptFuncParam{
					...
					{Name: "room", Type: "RoomObject", Description: "The room the mob is in."},
					{Name: "eventDetails", Type: "DieEventDetails", Description: "Contains sourceId, sourceType, and attackerCount (int)."},
				},
				ReturnType:      "void",
				ReturnSemantics: "Return value is ignored.",
			...
			},
			{
				...
				Params: []ScriptFuncParam{
					...
					{Name: "eventDetails", Type: "PathEventDetails", Description: "Contains sourceId, sourceType, and status ('start', 'waypoint', or 'end')."},
				},
				ReturnType:      "boolean | void",
